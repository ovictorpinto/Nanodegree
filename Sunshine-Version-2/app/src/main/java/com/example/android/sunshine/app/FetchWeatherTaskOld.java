...
public class FetchWeatherTaskOld extends AsyncTask<String, Void, String[]> {

    private final String LOG_TAG = FetchWeatherTaskOld.class.getSimpleName();

    private ArrayAdapter<String> mForecastAdapter;
    private final Context mContext;

    public FetchWeatherTaskOld(Context context, ArrayAdapter<String> forecastAdapter) {
        mContext = context;
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs
                .getString(mContext.getString(R.string.pref_units_key), mContext.getString(R.string.unit_metric_value));

        if (unitType.equals(mContext.getString(R.string.unit_imperial_value))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.unit_metric_value))) {
    ...
    String[] convertContentValuesToUXFormat(Vector<ContentValues> cvv) {
        ...
        for (int i = 0; i < cvv.size(); i++) {
            ...
            String highAndLow = formatHighLows(weatherValues.getAsDouble(WeatherEntry.COLUMN_MAX_TEMP), weatherValues
                    .getAsDouble(WeatherEntry.COLUMN_MIN_TEMP));
